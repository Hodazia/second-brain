...
/*
const DialogContentAdd = ({onAdd, onClose}: AddContentDialogProps )
*/
const DialogContentAdd: React.FC<AddContentDialogProps> = ({ onAdd, onClose }) => {
...
export default DialogContentAdd;